...
import { IsOptional, IsString, Matches, Length, IsUUID, IsArray } from 'class-validator';
...
export class UpdateUserDto extends PartialType(
  ...
  @ApiProperty({
    description: 'System role ID to assign to this user (determines base permissions and hierarchy level)',
  ...
  @ApiProperty({ 
    description: 'Array of custom role IDs to assign to this user (multiple roles)',
    type: [String],
